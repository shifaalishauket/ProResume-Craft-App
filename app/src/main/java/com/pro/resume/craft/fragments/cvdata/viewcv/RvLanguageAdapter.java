...
public class RvLanguageAdapter extends RecyclerView.Adapter<RvLanguageAdapter.ViewHolder> {

    private ArrayList<DTOlanguages> mlist;
    public int tempname;
    private Context context;

    private View view;

    public RvLanguageAdapter(ArrayList<DTOlanguages> mlist, int tempname, Context context) {
        this.mlist = mlist;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.skillname.setText(mlist.get(position).getLanguageName());
        ...
        if (tempname == R.layout.template_3 || tempname == R.layout.template_6 || tempname == R.layout.template_7 || tempname == R.layout.template_9 || tempname == R.layout.template_10 || tempname == R.layout.template_11 ){
            switch (mlist.get(position).getLanguageLevel()) {
                case "Beginner":
