...
@AndroidEntryPoint
public class CoverOptionsSheet extends BottomSheetDialogFragment {

    @Inject
    AppDatabase appDatabase;
    private DTOCoverLetter cvData = null;
    @Override
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.previewCV).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("letter", cvData.result); // Add your data to the bundle
                NavHostFragment.findNavController(CoverOptionsSheet.this).navigate(R.id.coverLetterPreviewFragment,bundle);
                dismiss();
            }
        });
        ...
        view.findViewById(R.id.deleteCV).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (appDatabase != null) {
                    appDatabase.userDao().deleteCoverByEmail(cvData.getEmail());
                    deleteFile(cvData);
                    dismiss();
                } else {
    ...
    public void setCoverData(DTOCoverLetter cvData) {
        this.cvData = cvData;
    }
    ...
    private void deleteFile(DTOCoverLetter cvData) {
